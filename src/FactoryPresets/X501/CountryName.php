 ...
 * X.501 country name
 */
#[FactoryTypeClass(CountryName::OID, X501AttributeTypeOid::class)]
#[FactoryTypeClass(CountryName::SHORT_NAME, X501AttributeTypeShortName::class)]
class CountryName extends AttributeType
{
     ...
     * Current OID
     */
    public const OID = '2.5.4.6';
    /**
     * Current short name
     */
    public const SHORT_NAME = 'C';
    /**
     * Current long name
     */
    public const LONG_NAME = 'countryName';
}