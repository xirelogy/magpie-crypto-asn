 ...
 * SHA512-256
 */
#[FactoryTypeClass(Sha512_256::OID, HmacOid::class)]
class Sha512_256 extends Hmac
{
    use CommonHmac;
     ...
     * Current OID
     */
    public const OID = '1.2.840.113549.2.13';
    /**
     * Current hash algorithm
     */
    public const HASH_TYPECLASS = CommonHashTypeClass::SHA512_256;
}